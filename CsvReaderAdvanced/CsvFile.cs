...
public class CsvFile : ICsvFile, IDisposable
{
    ...
    public BaseType GetBaseType( //when lines are pre-loaded
        int column,
        ...
        string? dateTimeOffsetFormat = null)
    {
        ...
        var lines = this.Lines; //Read(path, encoding, hasHeader);
    ...
    public CsvFieldStats GetFieldStats(int column, //when lines are pre-loaded
        BaseType assumedType,
        bool hasHeader = true,
        int maxRows = int.MaxValue)
    {
